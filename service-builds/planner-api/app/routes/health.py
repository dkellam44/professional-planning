"""Health check routes for Planner API."""
...
async def health_check():
    ...
    gcal_ok, gcal_details = await gcal.check_health()
    dependencies.append(
        HealthDependency(name="google-calendar", status="up" if gcal_ok else "down", details=gcal_details)
    )
