"""Application configuration for Planner API service."""
...
class Settings(BaseSettings):
    ...
    # Google Calendar
    gcal_credentials_path: str = "/app/credentials/gcal.json"
    gcal_timezone: str = "America/Los_Angeles"
